...
"""
  ...
  "Tx codec" should {
    ...
    "decode" in {
      ...
      val txouts = List(
        TxOut(
          value = 4632880204564398080L,
          pk_script = hex"76a9141aa0cd1cbea6e7458a7abad512a9d9ea1afb225e88ac"
        ),
        TxOut(
          value = -9152746251769348096L,
          pk_script = hex"76a9140eab5bea436a0484cfab12485efda0b78b4ecc5288ac"
        )
      )
      val locktime = 0L
